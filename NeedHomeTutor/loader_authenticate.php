    ...
    if(isset($_GET["Type"])){
      ...
      if(strcmp($type,"Tutor")==0){
          if(isset($_GET['FirstName'], $_GET['LastName'], $_GET['Age'], $_GET['MobileNumber'], $_GET['Username'], $_GET['Password'], $_GET['gender'], $_GET['Experience'])){
            ...
            $class_nursery = (in_array("nursery", $classes)) ? 1 : 0;
            $class_ = (in_array("kg", $classes)) ? 1 : 0;
            $class_1 = (in_array("1", $classes)) ? 1 : 0;
            $class_2 = (in_array("2", $classes)) ? 1 : 0;
            $class_3 = (in_array("3", $classes)) ? 1 : 0;
            $class_4 = (in_array("4", $classes)) ? 1 : 0;
            $class_5 = (in_array("5", $classes)) ? 1 : 0;
            $class_6 = (in_array("6", $classes)) ? 1 : 0;
            $class_7 = (in_array("7", $classes)) ? 1 : 0;
            $class_8 = (in_array("8", $classes)) ? 1 : 0;
            $class_9 = (in_array("9", $classes)) ? 1 : 0;
            $class_10 = (in_array("10", $classes)) ? 1 : 0;
            $class_11 = (in_array("11", $classes)) ? 1 : 0;
            $class_12 = (in_array("12", $classes)) ? 1 : 0;
